...
.w3-badge {height:13px;width:13px;padding:0}
    ...
    ResultSet  rs = DB.executequery("select * from newcar ORDER BY RAND() LIMIT 10 "); 
    ResultSet  rd = DB.executequery("select count(*) as emicount from newcar ORDER BY RAND() LIMIT 10 "); 
    rs.next();
    %>
