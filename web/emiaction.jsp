...
.w3-badge {height:13px;width:13px;padding:0}
    ...
    ResultSet  rs = DB.executequery("select * from newcar where emi between '"+range1+"' and '"+range2+"' "); 
    ResultSet  rd = DB.executequery("select count(*) as emicount from newcar where emi between '"+range1+"' and '"+range2+"' "); 
    ...
    {          
      ...
      %>
													    ...
													    <p class="block-subtitle">                                                                                    
                                                                                              <a href="emilist.jsp">No Results Found , Search For Another EMI Range </a>       
                                                                                                            </p>
